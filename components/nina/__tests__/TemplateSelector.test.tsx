...
const resetStore = () => {
  ...
  act(() => {
    ...
    const customTemplates = store.templates.filter(t => t.category === 'custom');
...
describe('TemplateSelector', () => {
  ...
  describe('Template Display', () => {
    it('should display default templates', async () => {
      ...
      const store = useMultiSequenceStore.getState();
      const defaultTemplates = store.templates.filter(t => t.category === 'default');
  ...
  describe('Mode-Based Filtering', () => {
    it('should show all templates in advanced mode', async () => {
      ...
      await waitFor(() => {
        ...
        const templates = store.templates.filter(t => t.category === 'default');
