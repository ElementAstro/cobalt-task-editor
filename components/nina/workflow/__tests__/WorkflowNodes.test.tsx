...
describe('Workflow Utilities', () => {
  ...
  describe('getItemTypeColor', () => {
    it('should return color for camera items', () => {
      const color = getItemTypeColor('NINA.Sequencer.SequenceItem.Camera.CoolCamera, NINA.Sequencer');
      expect(color).toBeDefined();
      expect(typeof color).toBe('string');
    });

    it('should return color for imaging items', () => {
      const color = getItemTypeColor('NINA.Sequencer.SequenceItem.Imaging.TakeExposure, NINA.Sequencer');
      expect(color).toBeDefined();
      expect(typeof color).toBe('string');
    });

    it('should return color for container items', () => {
      const color = getItemTypeColor('NINA.Sequencer.Container.SequentialContainer, NINA.Sequencer');
      expect(color).toBeDefined();
      expect(typeof color).toBe('string');
    });
