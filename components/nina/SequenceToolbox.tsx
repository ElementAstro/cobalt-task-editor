  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      <Tabs
        value={activeTab}
        onValueChange={(v) =>
          setActiveTab(v as "items" | "conditions" | "triggers")
        }
                      ...
                      <Tooltip key={item.type}>
                        <TooltipTrigger asChild>
                          ...
                          >
                            ...
                            />
                            <span className="truncate flex-1 text-left">
                              {getTranslatedConditionName(item)}
                            </span>
                            <Plus
                        ...
                        >
                          <p className="text-xs">
                            {getTranslatedConditionDescription(item)}
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    );
                  ...
                  {filteredTriggers.map((item) => {
                    ...
                    return (
                      <Tooltip key={item.type}>
                        ...
                        >
                          <p className="text-xs">
                            {getTranslatedTriggerDescription(item)}
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    );
