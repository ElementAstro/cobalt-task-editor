...
export interface IAutofocusAfterTemperatureChangeTrigger
  extends ISequenceTrigger {
...
export function isSequenceContainer(
  item: ISequenceItem,
): item is ISequenceContainer {
  return "Items" in item && "Strategy" in item;
}

export function isDeepSkyObjectContainer(
  item: ISequenceItem,
): item is IDeepSkyObjectContainer {
  return (
    item.$type ===
...
export function isSequentialContainer(
  item: ISequenceItem,
): item is ISequentialContainer {
  return (
    item.$type ===
...
export function isParallelContainer(
  item: ISequenceItem,
): item is IParallelContainer {
  return (
    item.$type === "NINA.Sequencer.Container.ParallelContainer, NINA.Sequencer"
  );
}
