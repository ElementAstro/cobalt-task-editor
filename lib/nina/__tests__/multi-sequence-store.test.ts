  ...
  describe("Tab Management", () => {
    ...
    describe("duplicateTab", () => {
      it("should duplicate a tab", () => {
        ...
        expect(result.current.tabs[1].sequence.title).toBe(
          "Original Tab (Copy)",
        );
      });
    });
  ...
  describe("Template Management", () => {
    describe("default templates", () => {
      it("should have default templates", () => {
        ...
        const defaultTemplates = result.current.templates.filter(
      ...
      it("should have normal mode templates", () => {
        ...
        const normalTemplates = result.current.templates.filter(
          (t) => t.mode === "normal",
        );
      ...
      it("should have advanced mode templates", () => {
        ...
        const advancedTemplates = result.current.templates.filter(
          (t) => t.mode === "advanced",
        );
    ...
    describe("deleteTemplate", () => {
      it("should delete a custom template", () => {
        ...
        let templateId = "";
        act(() => {
          templateId = result.current.saveAsTemplate(
            tabId,
            "My Template",
            "A custom template",
          );
        ...
        expect(
          result.current.templates.find((t) => t.id === templateId),
        ).toBeUndefined();
      });
      ...
      it("should not delete default templates", () => {
        ...
        const defaultTemplate = result.current.templates.find(
          (t) => t.category === "default",
        );
        const countBefore = result.current.templates.length;
    ...
    describe("updateTemplate", () => {
      ...
      it("should not update default templates", () => {
        ...
        act(() => {
          result.current.updateTemplate(defaultTemplate!.id, {
            name: "New Name",
          });
        });

        const template = result.current.templates.find(
