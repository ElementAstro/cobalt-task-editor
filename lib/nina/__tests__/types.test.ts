  ...
  describe("Enums", () => {
    describe("InstructionErrorBehavior", () => {
      it("should have ContinueOnError value", () => {
        expect(InstructionErrorBehavior.ContinueOnError).toBe(
          "ContinueOnError",
        );
      });
      ...
      it("should have SkipInstructionSetOnError value", () => {
        expect(InstructionErrorBehavior.SkipInstructionSetOnError).toBe(
          "SkipInstructionSetOnError",
        );
      });

      it("should have SkipToSequenceEndInstructions value", () => {
        expect(InstructionErrorBehavior.SkipToSequenceEndInstructions).toBe(
