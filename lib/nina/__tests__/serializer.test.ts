...
describe("Serializer", () => {
  ...
  describe("exportToNINA", () => {
    ...
    it("should export global triggers", () => {
      ...
      expect(parsed.Triggers.$values[0].$type).toBe(
  ...
  describe("importFromNINA", () => {
    ...
    it("should import sequence with items", () => {
      ...
      expect(sequence.startItems[0].type).toBe(
        "NINA.Sequencer.SequenceItem.Camera.CoolCamera, NINA.Sequencer",
      );
