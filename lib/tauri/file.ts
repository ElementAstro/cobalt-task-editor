 ...
 */
export async function loadSimpleSequenceFile(
  path: string,
 ...
 */
export async function saveSimpleSequenceFile(
  path: string,
 ...
 */
export async function importTargetsCsvContent(
  content: string,
 ...
 */
export async function exportSequenceXml(
  sequence: SimpleSequence,
): Promise<string> {
  if (isTauri()) {
 ...
 */
export async function exportSequenceTargetSet(
  sequence: SimpleSequence,
): Promise<string> {
  if (isTauri()) {
 ...
 * Auto-save sequence
 */
export async function autoSaveSequence(
  sequence: SimpleSequence,
): Promise<string> {
  if (isTauri()) {
