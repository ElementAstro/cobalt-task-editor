...
export function I18nProvider({ children, defaultLocale }: I18nProviderProps) {
  const initialLocale: Locale =
    defaultLocale && translations[defaultLocale] ? defaultLocale : "en";
  ...
  useEffect(() => {
    ...
    const resolvedDefault =
      defaultLocale && translations[defaultLocale]
        ...
        : detectBrowserLocale();
    const nextLocale =
      stored && translations[stored] ? stored : resolvedDefault;
...
export function getItemNameKey(
  type: string,
): keyof Translations["ninaItems"] | null {
  const typeMap: Record<string, keyof Translations["ninaItems"]> = {
    ...
    "NINA.Sequencer.SequenceItem.Camera.SetUSBLimit, NINA.Sequencer":
      "setUSBLimit",
    ...
    "NINA.Sequencer.SequenceItem.Telescope.UnparkScope, NINA.Sequencer":
      "unparkScope",
    "NINA.Sequencer.SequenceItem.Telescope.FindHome, NINA.Sequencer":
      "findHome",
    "NINA.Sequencer.SequenceItem.Telescope.SetTracking, NINA.Sequencer":
      "setTracking",
    "NINA.Sequencer.SequenceItem.Focuser.MoveFocuserAbsolute, NINA.Sequencer":
      "moveFocuserAbsolute",
    "NINA.Sequencer.SequenceItem.Focuser.MoveFocuserRelative, NINA.Sequencer":
      "moveFocuserRelative",
    ...
    "NINA.Sequencer.SequenceItem.Rotator.MoveRotatorAbsolute, NINA.Sequencer":
      "moveRotatorAbsolute",
    "NINA.Sequencer.SequenceItem.Rotator.MoveRotatorRelative, NINA.Sequencer":
      "moveRotatorRelative",
    "NINA.Sequencer.SequenceItem.Rotator.MoveRotatorMechanical, NINA.Sequencer":
    ...
    "NINA.Sequencer.SequenceItem.Dome.SynchronizeDome, NINA.Sequencer":
      "synchronizeDome",
    "NINA.Sequencer.SequenceItem.Dome.EnableDomeSynchronization, NINA.Sequencer":
      "enableDomeSync",
    "NINA.Sequencer.SequenceItem.Dome.DisableDomeSynchronization, NINA.Sequencer":
      "disableDomeSync",
    "NINA.Sequencer.SequenceItem.Dome.SlewDomeAbsolute, NINA.Sequencer":
      "slewDome",
    ...
    "NINA.Sequencer.SequenceItem.FlatDevice.ToggleLight, NINA.Sequencer":
      "toggleLight",
    "NINA.Sequencer.SequenceItem.FlatDevice.OpenCover, NINA.Sequencer":
      "openCover",
    "NINA.Sequencer.SequenceItem.FlatDevice.CloseCover, NINA.Sequencer":
      "closeCover",
    "NINA.Sequencer.SequenceItem.SafetyMonitor.WaitUntilSafe, NINA.Sequencer":
      "waitUntilSafe",
    "NINA.Sequencer.SequenceItem.Switch.SetSwitchValue, NINA.Sequencer":
      "setSwitchValue",
    "NINA.Sequencer.SequenceItem.Utility.Annotation, NINA.Sequencer":
      "annotation",
    "NINA.Sequencer.SequenceItem.Utility.MessageBox, NINA.Sequencer":
      "messageBox",
    ...
    "NINA.Sequencer.SequenceItem.Utility.WaitForAltitude, NINA.Sequencer":
      "waitForAltitude",
    "NINA.Sequencer.SequenceItem.Utility.WaitForMoonAltitude, NINA.Sequencer":
      "waitForMoonAltitude",
    ...
    "NINA.Sequencer.SequenceItem.Utility.SaveSequence, NINA.Sequencer":
      "saveSequence",
...
export function getConditionNameKey(
  type: string,
): keyof Translations["ninaConditions"] | null {
  const typeMap: Record<string, keyof Translations["ninaConditions"]> = {
    ...
    "NINA.Sequencer.Conditions.AltitudeCondition, NINA.Sequencer":
      "loopWhileAltitude",
    "NINA.Sequencer.Conditions.AboveHorizonCondition, NINA.Sequencer":
      "loopWhileAboveHorizon",
    "NINA.Sequencer.Conditions.MoonAltitudeCondition, NINA.Sequencer":
      "loopWhileMoonAltitude",
    "NINA.Sequencer.Conditions.SunAltitudeCondition, NINA.Sequencer":
      "loopWhileSunAltitude",
    "NINA.Sequencer.Conditions.MoonIlluminationCondition, NINA.Sequencer":
      "loopWhileMoonIllumination",
...
export function getTriggerNameKey(
  type: string,
): keyof Translations["ninaTriggers"] | null {
...
export function getCategoryKey(
  category: string,
): keyof Translations["categories"] | null {
...
export function getItemDescriptionKey(
  type: string,
): keyof Translations["itemDescriptions"] | null {
...
export function getConditionDescriptionKey(
  type: string,
): keyof Translations["conditionDescriptions"] | null {
...
export function getTriggerDescriptionKey(
  type: string,
): keyof Translations["triggerDescriptions"] | null {
